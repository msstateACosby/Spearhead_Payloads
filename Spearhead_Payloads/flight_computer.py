...
class Flight_Node(Node):
    ...
    def timer_callback(self):
        ...
        msg = FlightComputer()
        msg.time = time.time()
        msg.gravity = self.bno.gravity
        msg.acceleration = self.bno.acceleration
        temp = self.bno.linear_acceleration
        print(temp)
        msg.linear_acceleration = temp
        msg.quaternion_orientation = self.bno.quaternion
